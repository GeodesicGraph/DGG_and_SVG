...
public:
	...
	inline Real & XMax() { return Max[0]; }
	inline Real & YMax() { return Max[1]; }
	inline Real & ZMax() { return Max[2]; }
	inline Real & XMin() { return Min[0]; }
	inline Real & YMin() { return Min[1]; }
	inline Real & ZMin() { return Min[2]; }
	
	inline Real GetXMax() const { return Max[0]; }
	inline Real GetYMax() const { return Max[1]; }
	inline Real GetZMax() const { return Max[2]; }
	inline Real GetXMin() const { return Min[0]; }
	inline Real GetYMin() const { return Min[1]; }
	inline Real GetZMin() const { return Min[2]; }
