// PreviousCH.cpp: implementation of the  CPreviousCHForFD class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
 CPreviousCHForFD:: CPreviousCHForFD(const CRichModel& inputModel, const vector<int> &indexOfSourceVerts) : CExactMethodForDGP(inputModel, indexOfSourceVerts)
{
	nameOfAlgorithm = "CH";
}

 CPreviousCHForFD::~ CPreviousCHForFD()
{
}

void  CPreviousCHForFD::InitContainers()
{
	//m_InfoAtAngles.resize(model.GetNumOfEdges());
	memory += double(model.GetNumOfEdges()) * sizeof(InfoAtAngle) / 1024 / 1024;
}

void  CPreviousCHForFD::BuildSequenceTree()
{
...
void  CPreviousCHForFD::FillExperimentalResults()
{
	NPE = 1;
...
void  CPreviousCHForFD::ClearContainers()
{
...
void  CPreviousCHForFD::AddIntoQueueOfPseudoSources(QuoteInfoAtVertex& quoteOfPseudoSource)
{
	m_QueueForPseudoSources.push(quoteOfPseudoSource);
}

void  CPreviousCHForFD::AddIntoQueueOfWindows(QuoteWindow& quoteW)
{
	m_QueueForWindows.push(quoteW);
	++nCountOfWindows;
}

bool  CPreviousCHForFD::UpdateTreeDepthBackWithChoice()
{
	while (!m_QueueForPseudoSources.empty()
...
bool  CPreviousCHForFD::CheckValidityOfWindow(Window& w)
{
	return true;
}
